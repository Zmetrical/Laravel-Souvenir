...
class ElementSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $charms = [
            // Hello Kitty
            ['slug'=>'fg1',  'name'=>'Hello Kitty 1', 'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/hello-kitty/01.png', 'series_id'=>$hkId,  'price'=>35, 'is_large'=>true],
            ['slug'=>'fg2',  'name'=>'Hello Kitty 2', 'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/hello-kitty/02.png', 'series_id'=>$hkId,  'price'=>35, 'is_large'=>true],
            ['slug'=>'fg3',  'name'=>'Hello Kitty 3', 'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/hello-kitty/03.png', 'series_id'=>$hkId,  'price'=>35, 'is_large'=>true],
            ['slug'=>'fg4',  'name'=>'Hello Kitty 4', 'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/hello-kitty/04.png', 'series_id'=>$hkId,  'price'=>35, 'is_large'=>true, 'stock'=>'low'],
            ['slug'=>'fg5',  'name'=>'Hello Kitty 5', 'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/hello-kitty/05.png', 'series_id'=>$hkId,  'price'=>35, 'is_large'=>true],
            // BTS
            ['slug'=>'bts1', 'name'=>'BTS RM',        'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/1.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
            ['slug'=>'bts2', 'name'=>'BTS Jin',       'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/2.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
            ['slug'=>'bts3', 'name'=>'BTS Suga',      'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/3.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
            ['slug'=>'bts4', 'name'=>'BTS J-Hope',    'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/4.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
            ['slug'=>'bts5', 'name'=>'BTS Jimin',     'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/5.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
            ['slug'=>'bts6', 'name'=>'BTS V',         'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/6.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
            ['slug'=>'bts7', 'name'=>'BTS Jungkook',  'category'=>'charms', 'use_img'=>true, 'img_path'=>'elements/charms/bts/7.png',          'series_id'=>$btsId, 'price'=>40, 'is_large'=>true],
        ];
